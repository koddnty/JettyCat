...
public:
    ...
    WsMessage& setReason(const std::string& reason = "") {m_reason = reason; return *this; }
    WsMessage& setContent(const std::string& content) {m_content = content; return *this; }
    WsMessage& setFrom(const JettyCat::chat::userId id) {m_from = id; return *this; }
    WsMessage& setTo(const JettyCat::chat::userId id) {m_to = id; return *this; }
